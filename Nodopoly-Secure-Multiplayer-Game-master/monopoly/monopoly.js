...
game_ns._draw_setup.draw_player_wrappers = function(max) {
  ...
  var content = "";
	...
	var content_intel1 = "";
	content_intel1 += "<select class='player-intel' id='player1' title='Choose whether this player is controled by a human or by the computer.' style='display:none'>";
	content_intel1 += "	<option value='0' selected='selected'>Human</option>";
	content_intel1 += "	<option value='1'>AI (Test)</option>";
	content_intel1 += "</select>";

	var content_intel2 = "";
	content_intel2 += "<select class='player-intel' title='Choose whether this player is controled by a human or by the computer.' style='display:none'>";
	content_intel2 += "	<option value='0' selected='selected'>AI (Test)</option>";
	content_intel2 += "</select>";

	var content_intel3 = "";
	content_intel3 += "<select class='player-intel' title='Choose whether this player is controled by a human or by the computer.' style='display:none'>";
	content_intel3 += "	<option value='0' selected='selected'>AI (Test)</option>";
	content_intel3 += "</select>";

	var content_intel4 = "";
	content_intel4 += "<select class='player-intel' title='Choose whether this player is controled by a human or by the computer.' style='display:none'>";
	content_intel4 += "	<option value='0' selected='selected'>AI (Test)</option>";
	content_intel4 += "</select>";
  ...
  for (i = 1; i <= max; i++) {
	...
	if(count==3)
	content += "<input type='text'  disabled='disabled' class='player-name' title='Player name' maxlength='16' value='Alice@gmail.com' /> ";

	if(count==4)
	content += "<input type='text'  disabled='disabled' class='player-name' title='Player name' maxlength='16' value='Bob@gmail.com' /> ";

	content += content_colors;
	content += " ";
	count++;
	content += content_intel1;
	content += "</div>";
};
