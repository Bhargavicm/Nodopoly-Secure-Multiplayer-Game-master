...
var con = mysql.createConnection({
  host: "monopoly-gmu.coys1t7c5tpf.us-east-1.rds.amazonaws.com",
  user: "monopolyGmu",
  password: "monopolyGmu",
  database: "monopolyGmu",
...
app.get('/Bhargavi',function(req,res) {
  res.sendFile(path.join(__dirname+'/public/views/Bhargavi.html'));
});*/
// ended by KP
...
app.post('/register', function(req, res) {
  ...
  console.log("Katha Parikh and Bhargavi//....");
  var name = req.body.name;
  var email = req.body.email;
  var password = req.body.password;
  console.log("post received: %s %s", name, password);
...
app.post('/login', function(req, res){
  ...
  if(errors){
    console.log(errors);
    return res.render('login.html', {error: errors});
  }
